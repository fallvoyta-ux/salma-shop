...
export async function seedDatabase() {
  ...
  const settingsData = [
    { key: 'store_name', value: 'Salma Shop', description: 'Nom officiel de la boutique' },
    { key: 'store_subtitle', value: 'Chic Ladies - Vente Articles Divers', description: 'Sous-titre de la marque' },
    { key: 'store_slogan', value: 'Se vêtir à tous prix 💜 | S’habiller selon son Budget 🌹', description: 'Slogans officiels' },
    { key: 'store_phone', value: '+221 77 201 86 97', description: 'Téléphone officiel Dakar' },
    ...
    { key: 'announcement_bar', value: '✨ Bienvenue chez Salma Shop ! Vente Articles Divers Dakar 🇸🇳 • Se vêtir à tous prix 💜 | S’habiller selon son Budget 🌹 • WhatsApp : +221 77 201 86 97', description: 'Bannière promotionnelle haute' },
