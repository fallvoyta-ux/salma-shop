...
export async function seedDatabase() {
  ...
  const settingsData = [
    ...
    { key: 'store_phone', value: '+221 78 340 48 39', description: 'Téléphone officiel WhatsApp Dakar' },
    { key: 'store_phone_alt1', value: '+221 76 251 11 12', description: 'Téléphone Mobile direct' },
    { key: 'store_phone_alt2', value: '+221 77 201 86 97', description: 'Téléphone Service & Wave' },
    { key: 'store_whatsapp', value: '221783404839', description: 'Numéro WhatsApp pour commandes directes' },
    ...
    { key: 'announcement_bar', value: '✨ Global Business Services Grp SF • Groupe Salma Fall • « La Qualité fait la Différence 💜🕊️🌹 » • WhatsApp : +221 78 340 48 39 • 76 251 11 12 • 77 201 86 97', description: 'Bannière promotionnelle haute' },
